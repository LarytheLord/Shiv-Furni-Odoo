...
export const productController = {
    ...
    async create(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { code, name, description, categoryId, costPrice, salePrice, taxRate, unit } = req.body;
    ...
    async update(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { id } = req.params;
            const { code, name, description, categoryId, costPrice, salePrice, taxRate, unit, isActive } = req.body;
