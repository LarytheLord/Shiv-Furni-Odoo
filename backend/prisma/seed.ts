...
async function main() {
  ...
  const categories = await Promise.all([
    ...
    prisma.productCategory.create({
      data: { name: 'Raw Materials', code: 'RM' },
    }),
  ]);
  ...
  const analyticalAccounts = await Promise.all([
    ...
    prisma.analyticalAccount.create({
      data: { code: 'CC003', name: 'Labor', description: 'Direct labor costs' },
    }),
    prisma.analyticalAccount.create({
      data: {
        code: 'CC004',
        ...
        create: [
          {
            ...
            originalPlannedAmount: 500000,
          },
          {
            analyticalAccountId: analyticalAccounts[1].id,
            plannedAmount: 800000,
            originalPlannedAmount: 800000,
          },
          {
            analyticalAccountId: analyticalAccounts[2].id,
            plannedAmount: 300000,
            originalPlannedAmount: 300000,
          },
          {
            analyticalAccountId: analyticalAccounts[3].id,
            plannedAmount: 150000,
            originalPlannedAmount: 150000,
          },
          {
            analyticalAccountId: analyticalAccounts[4].id,
            plannedAmount: 200000,
            originalPlannedAmount: 200000,
          },
          {
            analyticalAccountId: analyticalAccounts[5].id,
            plannedAmount: 100000,
            originalPlannedAmount: 100000,
          },
          {
            analyticalAccountId: analyticalAccounts[6].id,
            plannedAmount: 120000,
            originalPlannedAmount: 120000,
          },
        ],
      },
    },
    ...
    prisma.customerInvoice.create({
      data: {
        ...
        lines: {
          create: [
            {
              productId: products[0].id, // Royal Teak Sofa Set
              quantity: 1,
              unitPrice: 75000,
              taxRate: 18,
              subtotal: 75000,
              taxAmount: 13500,
              total: 88500,
              analyticalAccountId: analyticalAccounts[4].id, // Marketing (Sales)
            },
          ],
        },
      },
    }),
    // Invoice 2: CONFIRMED (Open)
    prisma.customerInvoice.create({
      data: {
        ...
        lines: {
          create: [
            {
              productId: products[2].id, // King Size Bed
              quantity: 1,
              unitPrice: 42000,
              taxRate: 18,
              subtotal: 42000,
    ...
    prisma.customerInvoice.create({
      data: {
        ...
        lines: {
          create: [
            {
              productId: products[4].id, // Dining Table
              quantity: 1,
              unitPrice: 32000,
              taxRate: 18,
              subtotal: 32000,
