    ...
    const vendors = await Promise.all([
        ...
        prisma.contact.create({
            data: {
                ...
                gstin: '08AABCM5678B2Z6',
                address: '123 Textile Hub',
                city: 'Jaipur',
                state: 'Rajasthan',
                pincode: '302001',
                type: ContactType.VENDOR
    ...
    const customers = await Promise.all([
        prisma.contact.create({
            data: {
                ...
                gstin: '08AABCG3456D4Z8',
                address: '1 Royal Heritage Lane',
                city: 'Jaipur',
                state: 'Rajasthan',
                pincode: '302001',
        ...
        prisma.contact.create({
            data: {
                ...
                gstin: '08AABCU7890E5Z9',
                address: '56 Design District',
                city: 'Delhi',
                state: 'Delhi',
                pincode: '110001',
                type: ContactType.CUSTOMER
