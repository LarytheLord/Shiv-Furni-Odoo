...
export default function VendorOrders() {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            setOrders([
                { id: '1', poNumber: 'PO-2024-055', date: '2024-03-25', total: 156000, status: 'CONFIRMED' },
                { id: '2', poNumber: 'PO-2024-052', date: '2024-03-20', total: 42000, status: 'DRAFT' },
            ]);
        }, 500);
    }, []);
    ...
    const columns = [
        {
            ...
            accessor: 'poNumber',
            width: '25%',
            render: (row) => <span style={{ fontWeight: 600, color: '#0f172a' }}>{row.poNumber}</span>
        },
        {
            header: 'Date',
            accessor: 'date',
