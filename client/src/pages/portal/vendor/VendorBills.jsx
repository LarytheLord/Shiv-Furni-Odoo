...
export default function VendorBills() {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            setBills([
                { id: '1', billNumber: 'BILL-001', date: '2024-03-26', dueDate: '2024-04-10', amount: 156000, status: 'OPEN' },
                { id: '2', billNumber: 'BILL-892', date: '2024-03-10', dueDate: '2024-03-20', amount: 24000, status: 'PAID' },
            ]);
        }, 500);
    }, []);
    ...
    const columns = [
        {
            ...
            accessor: 'billNumber',
            width: '20%',
            render: (row) => <span style={{ fontWeight: 600, color: '#0f172a' }}>{row.billNumber}</span>
        },
        {
            header: 'Bill Date',
            accessor: 'date',
