...
export default function CustomerOrders() {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            setOrders([
                { id: '1', soNumber: 'SO2024001', date: '2024-03-10', total: 45000, status: 'CONFIRMED' },
                { id: '2', soNumber: 'SO2024008', date: '2024-03-15', total: 12500, status: 'DRAFT' },
                { id: '3', soNumber: 'SO2024012', date: '2024-03-20', total: 8900, status: 'DONE' },
            ]);
            setLoading(false);
        }, 500);
    }, []);
    ...
    const columns = [
        {
            ...
            accessor: 'soNumber',
            width: '25%',
            render: (row) => <span style={{ fontWeight: 600, color: '#0f172a' }}>{row.soNumber}</span>
        },
        {
            header: 'Date',
            accessor: 'date',
        ...
        },
        {
            ...
            width: '25%',
            render: (row) => (
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontFamily: 'monospace', fontWeight: 600 }}>
